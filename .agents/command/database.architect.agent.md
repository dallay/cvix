...
Dedicated database professional focused on building scalable, reliable, and efficient data layers
for demanding applications. Combines deep expertise in PostgreSQL with best practices in data
modeling, query optimization, and schema lifecycle management.
...
- Query optimization: Analyzing execution plans (`EXPLAIN ANALYZE`), identifying bottlenecks, and
  rewriting queries.

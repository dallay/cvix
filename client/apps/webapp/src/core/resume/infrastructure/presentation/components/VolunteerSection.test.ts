...
describe('VolunteerSection.vue', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render volunteer entry when provided', () => {
      ...
      expect(wrapper.find('[data-testid="volunteer-organization-0"]').exists()).toBe(true);
    });
    ...
    it('should render multiple volunteer entries', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-organization-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="volunteer-organization-1"]').exists()).toBe(true);
    });
  ...
  describe('highlights management', () => {
    it('should render highlights when provided', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-highlight-0-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="volunteer-highlight-0-1"]').exists()).toBe(true);
    });
  ...
  describe('form validation', () => {
    it('should mark required fields', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-organization-0"]').attributes('required')).toBeDefined();
      expect(wrapper.find('[data-testid="volunteer-position-0"]').attributes('required')).toBeDefined();
      expect(wrapper.find('[data-testid="volunteer-start-date-0"]').attributes('required')).toBeDefined();
    });
    ...
    it('should have correct input types', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-url-0"]').attributes('type')).toBe('url');
      expect(wrapper.find('[data-testid="volunteer-start-date-0"]').attributes('type')).toBe('date');
      expect(wrapper.find('[data-testid="volunteer-end-date-0"]').attributes('type')).toBe('date');
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle empty highlights array', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-highlight-0-0"]').exists()).toBe(false);
    });
    ...
    it('should render multiple entries with different highlight counts', () => {
      ...
      const wrapper = mountComponent(volunteers);
      expect(wrapper.find('[data-testid="volunteer-highlight-0-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="volunteer-highlight-1-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="volunteer-highlight-1-2"]').exists()).toBe(true);
    });
  });
});

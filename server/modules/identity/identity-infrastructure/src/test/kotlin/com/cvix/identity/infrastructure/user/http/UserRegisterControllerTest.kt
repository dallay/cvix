...
import com.cvix.identity.infrastructure.user.http.request.RegisterUserRequest
...
class UserRegisterControllerTest {
    ...
    inner class ValidationErrorTests {
        ...
        @MethodSource(
            "com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#validationErrorScenarios",
        )
        ...
        @MethodSource(
            "com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#exceptionValidationScenarios",
        )
        ...
        @MethodSource("com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#conflictScenarios")
    ...
    inner class CommandHandlerErrorTests {
        ...
        @ParameterizedTest(name = "Should handle {1} and return 400")
        @MethodSource(
            "com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#badRequestErrorMessages",
        )
        ...
        @MethodSource("com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#wrappedExceptions")
        ...
        @MethodSource("com.cvix.identity.infrastructure.user.http.UserRegisterControllerTest#serverErrorScenarios")

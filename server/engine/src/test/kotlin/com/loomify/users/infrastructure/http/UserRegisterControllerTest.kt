package com.loomify.users.infrastructure.http
...
import com.loomify.users.application.register.RegisterUserCommand
import com.loomify.users.infrastructure.http.request.RegisterUserRequest
...
class UserRegisterControllerTest {
    ...
    inner class ValidationErrorTests {
        ...
        @MethodSource(
            "com.loomify.users.infrastructure.http.UserRegisterControllerTest#validationErrorScenarios",
        )
        ...
        @MethodSource(
            "com.loomify.users.infrastructure.http.UserRegisterControllerTest#exceptionValidationScenarios",
        )
    ...
    inner class CommandHandlerErrorTests {
        ...
        @ParameterizedTest(name = "Should handle {1} and return 400")
        @MethodSource(
            "com.loomify.users.infrastructure.http.UserRegisterControllerTest#badRequestErrorMessages",
        )
        ...
        @MethodSource("com.loomify.users.infrastructure.http.UserRegisterControllerTest#wrappedExceptions")
        ...
        @MethodSource("com.loomify.users.infrastructure.http.UserRegisterControllerTest#serverErrorScenarios")

...
describe('ResumeGeneratorService', () => {
  ...
  beforeEach(() => {
    ...
    service = new ResumeGeneratorService(mockResumeGenerator, mockResumeValidator);
  });
  ...
  describe('generateResumePdf', () => {
    it('should generate PDF when resume data is valid', async () => {
      ...
      expect(mockResumeGenerator.generatePdf).toHaveBeenCalledWith(mockResume, 'en');
    ...
    it('should generate PDF with custom locale', async () => {
      ...
      expect(mockResumeGenerator.generatePdf).toHaveBeenCalledWith(mockResume, 'es');
    });

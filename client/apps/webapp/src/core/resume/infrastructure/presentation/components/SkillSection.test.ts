...
describe('SkillSection.vue', () => {
  ...
  describe('v-model binding', () => {
    it('should bind skill name field', async () => {
      ...
      expect((nameInput.element as HTMLInputElement).value).toBe('Web Development');
    });
  ...
  describe('keywords management', () => {
    ...
    it('should handle empty keywords array', () => {
      ...
      const wrapper = mountComponent(skills);
      expect(wrapper.find('[data-testid="skill-keyword-0-0"]').exists()).toBe(false);
    });
  });
  ...
  describe('form validation', () => {
    it('should mark required fields', () => {
      ...
      const wrapper = mountComponent(skills);
      expect(wrapper.find('[data-testid="skill-name-0"]').attributes('required')).toBeDefined();
    });
    ...
    it('should have correct input types', () => {
      ...
      const wrapper = mountComponent(skills);
      expect(wrapper.find('[data-testid="skill-name-0"]').attributes('type')).toBe('text');
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle multiple skills with keywords', () => {
      ...
      expect(wrapper.find('[data-testid="skill-keyword-0-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="skill-keyword-1-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="skill-keyword-1-1"]').exists()).toBe(true);
    });

...
describe("ProjectSection.vue", () => {
	...
	describe("rendering", () => {
		...
		it("should render project entry when provided", () => {
			...
			expect(wrapper.find('[data-testid="project-name-0"]').exists()).toBe(
				true,
			);
		});
		...
		it("should render multiple project entries", () => {
			...
			expect(wrapper.find('[data-testid="project-name-1"]').exists()).toBe(
				true,
			);
		});
	...
	describe("highlights management", () => {
		it("should render highlights when provided", () => {
			...
			const wrapper = mountComponent(projects);
			expect(
				wrapper.find('[data-testid="project-highlight-0-0"]').exists(),
			).toBe(true);
			expect(
				wrapper.find('[data-testid="project-highlight-0-1"]').exists(),
			).toBe(true);
			expect(
				wrapper.find('[data-testid="project-highlight-0-2"]').exists(),
			).toBe(true);
		});
		...
		it("should display highlight values correctly", () => {
			...
			expect((h1.element as HTMLInputElement).value).toBe(
				"Implemented authentication",
			);
			expect((h2.element as HTMLInputElement).value).toBe(
	...
	describe("form validation", () => {
		it("should mark required fields", () => {
			...
			expect(
				wrapper
					.find('[data-testid="project-description-0"]')
					.attributes("required"),
			).toBeDefined();
		});
	...
	describe("edge cases", () => {
		...
		it("should render multiple projects with different highlight counts", () => {
			...
			expect(
				wrapper.find('[data-testid="project-highlight-1-0"]').exists(),
			).toBe(true);
			expect(
				wrapper.find('[data-testid="project-highlight-1-3"]').exists(),
			).toBe(true);
		});

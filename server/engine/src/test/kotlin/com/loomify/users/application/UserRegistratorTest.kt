package com.loomify.users.application
...
import com.loomify.users.application.register.UserRegistrator
import com.loomify.users.domain.User
import com.loomify.users.domain.UserCreator
import com.loomify.users.domain.UserStoreException
import com.loomify.users.domain.event.UserCreatedEvent
...
class UserRegistratorTest {
    ...
    inner class IntegrationTestsWithRealImplementations {
        private val userCreator =
            InMemoryUserRepository()
        private val eventPublisher =
            InMemoryEventPublisher<UserCreatedEvent>()
    ...
    inner class UnitTestsWithMockedDependencies {
        ...
        fun `should create user and publish domain events when registration succeeds`(): Unit =
            runTest {
                ...
                val mockUserId: com.loomify.users.domain.UserId = mockk()

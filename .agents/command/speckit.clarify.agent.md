...
5. Integration after EACH accepted answer (incremental update approach):
    ...
    - Then immediately apply the clarification to the most appropriate section(s):
        ...
        - User interaction / actor distinction → Update User Stories or Actors subsection (if
          present) with clarified role, constraint, or scenario.
    ...
    - If the clarification invalidates an earlier ambiguous statement, replace that statement
      instead of duplicating; leave no obsolete contradictory text.

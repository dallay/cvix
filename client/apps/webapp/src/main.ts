...
// Initialize CSRF token in the background - DO NOT await this.
// The app can render while the token is being fetched.
// BaseHttpClient interceptor will automatically pause outgoing API
// calls until the CSRF promise is resolved, preventing race conditions.

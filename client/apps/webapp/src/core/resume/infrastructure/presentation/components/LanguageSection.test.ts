...
describe('LanguageSection.vue', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render language entry when provided', () => {
      ...
      expect(wrapper.find('[data-testid="language-name-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-fluency-0"]').exists()).toBe(true);
    });
    ...
    it('should render multiple language entries', () => {
      ...
      const wrapper = mountComponent(languages);
      expect(wrapper.find('[data-testid="language-name-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-name-1"]').exists()).toBe(true);
    });
  ...
  describe('v-model binding', () => {
    ...
    it('should bind fluency field', async () => {
      ...
      expect((fluencyInput.element as HTMLInputElement).value).toBe('Native speaker');
    });
    ...
    it('should display pre-filled data', () => {
      ...
      expect((fluency1.element as HTMLInputElement).value).toBe('Native speaker');
  ...
  describe('form validation', () => {
    it('should mark required fields', () => {
      ...
      const wrapper = mountComponent(languages);
      expect(wrapper.find('[data-testid="language-name-0"]').attributes('required')).toBeDefined();
      expect(wrapper.find('[data-testid="language-fluency-0"]').attributes('required')).toBeDefined();
    });
    ...
    it('should have correct input types', () => {
      ...
      const wrapper = mountComponent(languages);
      expect(wrapper.find('[data-testid="language-name-0"]').attributes('type')).toBe('text');
      expect(wrapper.find('[data-testid="language-fluency-0"]').attributes('type')).toBe('text');
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle single language', () => {
      ...
      const wrapper = mountComponent(languages);
      expect(wrapper.find('[data-testid="language-name-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-name-1"]').exists()).toBe(false);
    });
    ...
    it('should handle multiple languages with different fluency levels', () => {
      ...
      expect(wrapper.find('[data-testid="language-name-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-name-1"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-name-2"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="language-name-3"]').exists()).toBe(true);
    });

...
describe('EducationSection.vue', () => {
  ...
  describe('rendering', () => {
    ...
    it('should not show education entries when empty', () => {
      const wrapper = mountComponent();
      expect(wrapper.find('[data-testid="education-institution-0"]').exists()).toBe(false);
    });
    ...
    it('should render education entry when provided', async () => {
      ...
      const institutionInput = wrapper.find('[data-testid="education-institution-0"]');
    ...
    it('should render multiple education entries', async () => {
      ...
      expect(wrapper.find('[data-testid="education-institution-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="education-institution-1"]').exists()).toBe(true);
    });
  ...
  describe('v-model binding', () => {
    it('should bind institution field', async () => {
      ...
      expect((institutionInput.element as HTMLInputElement).value).toBe('Harvard University');
    });
    ...
    it('should bind start and end dates', async () => {
      ...
      const wrapper = mountComponent(educations);
      const startDateInput = wrapper.find('[data-testid="education-start-date-0"]');
      ...
      expect((startDateInput.element as HTMLInputElement).value).toBe('2015-09-01');
      expect((endDateInput.element as HTMLInputElement).value).toBe('2019-05-31');
    });
    ...
    it('should display pre-filled data', () => {
      ...
      const areaInput = wrapper.find('[data-testid="education-area-0"]');
      expect((areaInput.element as HTMLInputElement).value).toBe('Computer Science');
    });
  });
  ...
  describe('form validation', () => {
    it('should mark required fields', async () => {
      ...
      expect(wrapper.find('[data-testid="education-institution-0"]').attributes('required')).toBeDefined();
      expect(wrapper.find('[data-testid="education-area-0"]').attributes('required')).toBeDefined();
      expect(wrapper.find('[data-testid="education-studyType-0"]').attributes('required')).toBeDefined();
    });
    ...
    it('should have correct input types', async () => {
      ...
      expect(wrapper.find('[data-testid="education-url-0"]').attributes('type')).toBe('url');
      expect(wrapper.find('[data-testid="education-start-date-0"]').attributes('type')).toBe('date');
      expect(wrapper.find('[data-testid="education-end-date-0"]').attributes('type')).toBe('date');
    });
  });
  ...
  describe('edge cases', () => {
    it('should handle empty courses array', () => {
      ...
      const wrapper = mountComponent(educations);
      expect(wrapper.find('[data-testid="education-course-0-0"]').exists()).toBe(false);
    });
    ...
    it('should render courses when provided', () => {
      ...
      expect((course1.element as HTMLInputElement).value).toBe('Algorithms 101');
      expect((course2.element as HTMLInputElement).value).toBe('Data Structures');
    });
    ...
    it('should handle multiple education entries with courses', () => {
      ...
      expect(wrapper.find('[data-testid="education-course-0-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="education-course-1-0"]').exists()).toBe(true);
      expect(wrapper.find('[data-testid="education-course-1-1"]').exists()).toBe(true);
    });
  });
});

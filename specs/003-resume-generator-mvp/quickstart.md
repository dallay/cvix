...
**Note**: The `ghcr.io/dallay/texlive:2025` base image already includes `pdflatex` and commonly used packages. If you need additional LaTeX packages, you can build a custom image (see Advanced Setup section).
...
FROM ghcr.io/dallay/texlive:2025

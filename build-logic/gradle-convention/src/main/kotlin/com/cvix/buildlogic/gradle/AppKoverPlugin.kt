package com.cvix.buildlogic.gradle

import com.cvix.buildlogic.common.AppConfiguration
import com.cvix.buildlogic.common.ConventionPlugin
import com.cvix.buildlogic.common.extensions.isRelease
import com.cvix.buildlogic.common.extensions.kover
            ...
            filters {
                ...
                excludes {
                    annotatedBy(
                        ...
                        "com.cvix.common.domain.Generated",
                    )

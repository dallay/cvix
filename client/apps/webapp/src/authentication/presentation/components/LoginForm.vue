...
const handleOAuthLogin = (provider: string) => {
	...
	authStore.loginWithOAuth(provider, redirectUri);
};
</script>
    ...
    <form @submit="onSubmit" class="space-y-4">
      ...
      <div class="grid grid-cols-3 gap-2">
        ...
        >
          ...
          <span class="sr-only">Continue with Microsoft</span>
        </Button>
      ...
      <p class="text-center text-sm text-muted-foreground">
        ...
        <router-link to="/register" class="underline hover:text-primary">
          Sign up
        </router-link>
      </p>
    </form>

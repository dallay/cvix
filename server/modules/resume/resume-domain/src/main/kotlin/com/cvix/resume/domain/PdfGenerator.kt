...
fun interface PdfGenerator {
     ...
     * @throws com.cvix.resume.domain.exception.PdfGenerationException if generation fails
     * @throws com.cvix.resume.domain.exception.PdfGenerationTimeoutException if generation exceeds timeout
     */
